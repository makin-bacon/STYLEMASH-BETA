...
10. First time here? A short guided tour (five steps, skippable and rewindable) runs on your first visit. Click **Help** (top right) at any time to replay it; its last step links to the full written help. (Adding `?tour` to the URL also forces it to run, handy for demos.)
